...
// Dockerization: a single image runs the whole bundle. Deployable as-is to Railway
// (or any Docker host) — the server honours the injected $PORT and Bun binds 0.0.0.0.
writeFileSync(
...
writeFileSync(
  ...
  [
    '# Keep the image lean and reproducible. Everything the server needs (server.js,',
    '# public/, .env, package.json) is copied; these are not needed at runtime.',
    '.git',
    '.gitignore',
    'node_modules',
    'npm-debug.log',
